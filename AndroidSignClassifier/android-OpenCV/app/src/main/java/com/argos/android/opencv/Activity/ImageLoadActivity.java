...
import com.argos.android.opencv.Driving.AutoDriveJava;
...
public class ImageLoadActivity extends AppCompatActivity
{
    ...
    public void processImage()
    {
        ...
        else if (feature.equals("Vehicle Detection"))
        {
            ...
            TensorFlowInferenceInterface tensorflow = AutoDriveJava.initTensorflowModel(getAssets());
            AutoDriveJava.detectSpeedLimitLoadedImage(image, tensorflow);
        }
    }
