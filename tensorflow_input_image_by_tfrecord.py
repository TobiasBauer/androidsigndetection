...
from dir_traversal import tfrecord_auto_traversal

flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_integer("image_number", 145, "Number of images in your tfrecord, default is 300.")
...
def read_and_decode(filename_queue):
    ...
    current_image_object.image = tf.image.resize_image_with_crop_or_pad(image_raw, FLAGS.image_height,
